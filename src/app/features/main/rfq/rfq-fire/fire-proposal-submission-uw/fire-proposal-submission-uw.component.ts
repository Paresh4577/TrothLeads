...
import { FireDocumentsDto, IFireDocumentsDto } from '@models/dtos';
...
@Component({
  selector: 'gnx-fire-proposal-submission-uw',
  templateUrl: './fire-proposal-submission-uw.component.html',
  styleUrls: ['./fire-proposal-submission-uw.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class FireProposalSubmissionUwComponent {
  ...
  public SubmitForm() {
    ...
    this._RfqFireService.SubmitProposalSubmission(submitFormValue).subscribe(res => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
