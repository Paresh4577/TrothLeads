...
@Component({
  selector: 'gnx-rfq-fire-list',
  templateUrl: './rfq-fire-list.component.html',
  styleUrls: ['./rfq-fire-list.component.scss']
})
export class RfqFireListComponent {
...
*/
  ...
  // back button
  public addButton() {
    this._router.navigate([ROUTING_PATH.RFQFire.FireRaise])
  }
