...
@Component({
  selector: 'gnx-package-proposal-submission-uw',
  templateUrl: './package-proposal-submission-uw.component.html',
  styleUrls: ['./package-proposal-submission-uw.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class PackageProposalSubmissionUwComponent {
...
*/
  ...
  public submitForm(): void {
    ...
    this._RfqPackageService.submitProposalSubmission(submitFormValue).subscribe(res => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
