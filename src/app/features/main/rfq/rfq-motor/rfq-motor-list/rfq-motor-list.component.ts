...
@Component({
  selector: 'gnx-rfq-motor-list',
  templateUrl: './rfq-motor-list.component.html',
  styleUrls: ['./rfq-motor-list.component.scss'],
   providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class RfqMotorListComponent {
  ...
  PolicyList: BehaviorSubject<any>; //Store RFQ list
      ...
      listActions: [
        {
          ...
          hidden: (item) => (this._authService._userProfile?.value?.AuthKeys?.includes("RFQ-get"))
        },
        {
          name: "View",
          tooltip: "View Policy",
...
*/
  ...
  // back button
  public addButton() {
    this._router.navigate([ROUTING_PATH.RFQMotor.MotorRaise])
  }
