...
@Component({
  selector: 'gnx-travel-loading-payment-proof-sp',
  templateUrl: './travel-loading-payment-proof-sp.component.html',
  styleUrls: ['./travel-loading-payment-proof-sp.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class TravelLoadingPaymentProofSPComponent {
  ...
  */
  ...
  public SubmitForm() {
    ...
    this._RFQTravelService.SubmitLoadingPaymentProof(this.LoadingPaymentProofForm.value).subscribe(res => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
