...
@Component({
  selector: 'gnx-travel-rfq-list',
  templateUrl: './travel-rfq-list.component.html',
  styleUrls: ['./travel-rfq-list.component.scss']
})
export class TravelRfqListComponent {
  ...
  TravelRfqList: BehaviorSubject<any>; //Store RFQ list
  TravelRfqList$: Observable<any>;  // Observable for RFQ lits
  ...
  ngOnInit(): void {
    ...
    this.TravelRfqList = new BehaviorSubject(null);
    this.TravelRfqList$ = this.TravelRfqList.asObservable();
  ...
  */
  ...
  // back button
  public addButton() {
    this._router.navigate([ROUTING_PATH.RFQTravel.TravelRaise])
  }
