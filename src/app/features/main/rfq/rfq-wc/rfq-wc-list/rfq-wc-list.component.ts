...
@Component({
  selector: 'gnx-rfq-wc-list',
  templateUrl: './rfq-wc-list.component.html',
  styleUrls: ['./rfq-wc-list.component.scss']
})
export class RfqWcListComponent {
...
*/
  ...
  // back button
  public addButton() {
    this._router.navigate([ROUTING_PATH.RFQWC.WcRaise])
  }
