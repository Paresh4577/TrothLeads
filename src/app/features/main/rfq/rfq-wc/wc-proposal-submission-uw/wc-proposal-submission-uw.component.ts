...
import { WCDocumentsDto, IWCDocumentsDto } from '@models/dtos';
import { environment } from 'src/environments/environment';
import { MatStepper } from '@angular/material/stepper';
import { DisplayedWCPolicyPreriod } from '@config/rfq';

@Component({
  selector: 'gnx-wc-proposal-submission-uw',
  templateUrl: './wc-proposal-submission-uw.component.html',
  styleUrls: ['./wc-proposal-submission-uw.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class WcProposalSubmissionUwComponent {
  ...
  public SubmitForm() {
    ...
    this._RFQWcService.SubmitProposalSubmission(submitFormValue).subscribe(res => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
