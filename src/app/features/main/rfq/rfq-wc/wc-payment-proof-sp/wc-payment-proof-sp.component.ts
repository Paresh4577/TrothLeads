...
@Component({
  selector: 'gnx-wc-payment-proof-sp',
  templateUrl: './wc-payment-proof-sp.component.html',
  styleUrls: ['./wc-payment-proof-sp.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class WcPaymentProofSpComponent {
 ...
 */
  ...
  public SubmitForm() {
    ...
    this._RFQWcService.SubmitPaymentProof(this.PaymentProofForm.value).subscribe(res => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
