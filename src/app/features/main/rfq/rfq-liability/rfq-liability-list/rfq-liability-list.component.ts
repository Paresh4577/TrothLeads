...
@Component({
  selector: 'gnx-rfq-liability-list',
  templateUrl: './rfq-liability-list.component.html',
  styleUrls: ['./rfq-liability-list.component.scss']
})
export class RfqLiabilityListComponent {
  ...
  ngOnInit(): void {
    ...
    this._column.FilterConditions.Rules.push({
      Field: 'Category.Code',
      Operator: 'eq',
      Value: CategoryCodeEnum.Liability,
    });
...
*/
  ...
  // back button
  public addButton() {
    this._router.navigate([ROUTING_PATH.RFQLiability.LiabilityRaise])
  }
