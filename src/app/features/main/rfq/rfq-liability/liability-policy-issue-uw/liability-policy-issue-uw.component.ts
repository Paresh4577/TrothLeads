...
@Component({
  selector: 'gnx-liability-policy-issue-uw',
  templateUrl: './liability-policy-issue-uw.component.html',
  styleUrls: ['./liability-policy-issue-uw.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class LiabilityPolicyIssueUwComponent {
...
*/
  ...
  public submitForm(): void {
    ...
    this._rfqLiabilityService.submitPolicyIssue(this.policyIssueForm.value).subscribe(res => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
