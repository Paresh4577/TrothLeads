...
@Component({
  selector: 'gnx-rfq-miscellaneous-list',
  templateUrl: './rfq-miscellaneous-list.component.html',
  styleUrls: ['./rfq-miscellaneous-list.component.scss']
})
export class RfqMiscellaneousListComponent {
  ...
  ngOnInit(): void {
    ...
    this._column.FilterConditions.Rules.push({
      Field: 'Category.Code',
      Operator: 'eq',
      Value: CategoryCodeEnum.Miscellaneous,
    });
...
*/
  ...
  // back button
  public addButton() {
    this._router.navigate([ROUTING_PATH.RFQMiscellaneous.MiscellaneousRaise])
  }
