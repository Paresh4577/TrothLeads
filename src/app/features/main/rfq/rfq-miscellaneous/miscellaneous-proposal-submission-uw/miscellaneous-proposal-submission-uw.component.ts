...
@Component({
  selector: 'gnx-miscellaneous-proposal-submission-uw',
  templateUrl: './miscellaneous-proposal-submission-uw.component.html',
  styleUrls: ['./miscellaneous-proposal-submission-uw.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class MiscellaneousProposalSubmissionUwComponent {
  ...
  public SubmitForm() {
    ...
    this._RfqMiscellaneousService.SubmitProposalSubmission(submitFormValue).subscribe(res => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
