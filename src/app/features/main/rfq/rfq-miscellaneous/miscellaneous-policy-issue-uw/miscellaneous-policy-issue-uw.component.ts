...
@Component({
  selector: 'gnx-miscellaneous-policy-issue-uw',
  templateUrl: './miscellaneous-policy-issue-uw.component.html',
  styleUrls: ['./miscellaneous-policy-issue-uw.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class MiscellaneousPolicyIssueUwComponent {
  ...
  public SubmitForm() {
    ...
    this._RfqMiscellaneousService.SubmitPolicyIssue(this.PolicyIssueForm.value).subscribe(res => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
  ...
  */
  ...
  // Document formgroup
  private _initDocumentsForm(item: IMiscellaneousDocumentsDto): FormGroup {
