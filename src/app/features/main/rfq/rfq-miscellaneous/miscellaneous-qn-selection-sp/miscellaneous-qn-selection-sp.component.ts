...
import { MiscellaneousDocumentsDto, IMiscellaneousDocumentsDto, IMiscellaneousQNDocumentsDto } from '@models/dtos';
import { RfqMiscellaneousService } from '../rfq-miscellaneous.service';

@Component({
  selector: 'gnx-miscellaneous-qn-selection-sp',
  templateUrl: './miscellaneous-qn-selection-sp.component.html',
  styleUrls: ['./miscellaneous-qn-selection-sp.component.scss'],
  providers: [
    DatePipe,
    {
      provide: DateAdapter,
...
export class MiscellaneousQnSelectionSpComponent {
  ...
  public SubmitForm() {
    ...
    this._RfqMiscellaneousService.SubmitQNSelectionSP(SubmitFormValue).subscribe((res) => {
      if (res.Success) {
        this._alertservice.raiseSuccessAlert(res.Message, "false")
        this._router.navigate([ROUTING_PATH.Basic.Dashboard])
      }
...
*/
  public DonloadQNdocument() {
    ...
    if (SelectedQuotation) {
      this._RfqMiscellaneousService.DownloadQnDocument(SelectedQuotation.Id).subscribe(blob => {
