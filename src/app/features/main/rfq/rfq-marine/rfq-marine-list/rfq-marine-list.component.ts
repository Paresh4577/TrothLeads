...
@Component({
  selector: 'gnx-rfq-marine-list',
  templateUrl: './rfq-marine-list.component.html',
  styleUrls: ['./rfq-marine-list.component.scss']
})
export class RfqMarineListComponent {
  ...
  MarineRfqList: BehaviorSubject<any>; //Store RFQ list
  MarineRfqList$: Observable<any>;  // Observable for RFQ lits
  ...
  ngOnInit(): void {
    ...
    this.MarineRfqList = new BehaviorSubject(null);
    this.MarineRfqList$ = this.MarineRfqList.asObservable();
...
*/
  ...
  // back button
  public addButton() {
    this._router.navigate([ROUTING_PATH.RFQMarine.MarineRaise])
  }
