...
@Component({
  selector: 'gnx-slab-commission-calculation-matrix-list',
  templateUrl: './slab-commission-calculation-matrix-list.component.html',
  styleUrls: ['./slab-commission-calculation-matrix-list.component.scss']
})
export class SlabCommissionCalculationMatrixListComponent {

  //#region public properties
  public title: string = '' // Commission Cal Matrix List page header title
  public slabCommissionCalculationMatrixList: BehaviorSubject<any>; //Store CommissionCalMatrix list
  public slabCommissionCalculationMatrixList$: Observable<any>;  // Observable for CommissionCalMatrix lits
  ...
  private _api = API_ENDPOINTS.SlabCommissionCalMatrix.Base // CommissionCalMatrix list API
...
*/
  ...
  ngOnInit(): void {
    ...
    this.slabCommissionCalculationMatrixList = new BehaviorSubject(null);
    this.slabCommissionCalculationMatrixList$ = this.slabCommissionCalculationMatrixList.asObservable();
  ...
  public uploadCommissionMatrix(): void {
    this._router.navigate([ROUTING_PATH.SlabCommissionMatrix.CommissionCalculationMatrixModuleUpload])
  }
  ...
  private _loadLists(): void {
    ...
    this._dataService
      ...
      .subscribe(
        (res) => {
          if (res.Success) {
            this.slabCommissionCalculationMatrixList.next(res);
          }
        },
        (err) => {
        }
...
*/
  private _downloadUploadSheet(item): void {
    ...
    this._commissionMatrixService.downloadUploadedSlabCommissionMatrixFile(item.Id)
      .subscribe((blob: Blob) => {
